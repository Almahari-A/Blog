          ...
          <div class="min-w-0 flex-1">
            <form>
              ...
              <div class="mt-3 flex items-center justify-between">
                ...
                border border-transparent font-medium rounded-md shadow-sm text-black bg-indigo-600 
                hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                  Comment
                </button>
              </div>
            </form>
